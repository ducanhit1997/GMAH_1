var dataTable = $("#result").DataTable({
    ...
    "ordering": false,
    ajax: {
        url: '/api/reportapi/getallreport?status=null&idSemester=null',
        type: 'POST',
        headers: {
...
function LoadReportData() {
    ...
    dataTable.ajax.url('/api/reportapi/getallreport?status=' + $("#status").val() + "&idSemester=" + $("#selectedSemester").val());
